...
export class Config {
  ...
  'jhipster.mail.from' = 'API@localhost';
  'jhipster.swagger.default-include-pattern' = '/api/.*';
  'jhipster.swagger.title' = 'API API';
  'jhipster.swagger.description' = 'API API documentation';
  ...
  'eureka.instance.appname' = 'API';
  'eureka.instance.instanceId' = 'API:${random.value}';
